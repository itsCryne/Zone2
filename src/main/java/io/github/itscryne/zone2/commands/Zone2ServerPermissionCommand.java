...
public class Zone2ServerPermissionCommand implements CommandExecutor { // TODO: * perms
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) { // add|remove who
        ...
        if (args[0].equalsIgnoreCase("add")) {
            ...
            System.out.println(zone.getPerms());
            ...
            try {
                ...
                if (who instanceof Player) {
                    message = ChatColor.GREEN + "Dem Spieler " + ChatColor.RESET + ((Player) who).getDisplayName()
                            + ChatColor.GREEN + " wurde das Recht " + ChatColor.DARK_GREEN
                            + args[2].toUpperCase(new Locale("de")) + ChatColor.GREEN + " gewährt";
                } else {
            ...
            if (!removed) {
                if (who instanceof Player) {
                    ...
                    sender.sendMessage(ChatColor.YELLOW + "Der Spieler " + ChatColor.RESET + who.getName()
                            + ChatColor.YELLOW + " besitzt die Berechtigung " + ChatColor.RED
                            + args[2].toUpperCase(new Locale("de")) + ChatColor.YELLOW + " nicht");
                }
                return true;
            ...
            try {
                ...
                if (who instanceof Player) {
                    message = ChatColor.GREEN + "Dem Spieler " + ChatColor.RESET + ((Player) who).getDisplayName()
                            + ChatColor.GREEN + " wurde das Recht " + ChatColor.DARK_GREEN
                            + args[2].toUpperCase(new Locale("de")) + ChatColor.GREEN + " verwehrt";
                } else {
                    message = ChatColor.GREEN + "Dem Spieler " + ChatColor.RESET + who.getName() + ChatColor.GREEN
                            + " wurde das Recht " + ChatColor.DARK_GREEN + args[2].toUpperCase(new Locale("de"))
